...
*** my functions
	...
	(interactive (list (if current-prefix-arg
			 (file-name-as-directory
			  (read-directory-name "Project directory: " (concat "c:/Users/" user-login-name "/Projects/")))
			 default-directory)))
	(w32-shell-execute "open" "c:/Program Files/Git/git-bash.exe" (concat "--cd=" dir)))
